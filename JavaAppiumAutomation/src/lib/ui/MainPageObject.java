...
public class MainPageObject {
    ...
    public void assertElementsContainText(By by, String expected_text, String error_message)
    {
    ...
    public void waitForElementsToRender(By by, String error_message, long timeoutInSeconds)
    {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
